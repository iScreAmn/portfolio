...
export const featuredPortfolioSectionData = {
  eyebrow: "Избранное",
  title: "Проекты, которые решают задачи бизнеса",
  subtitle:
    "Создаю сайты и веб-приложения, которые помогают привлекать клиентов, автоматизировать процессы и развивать бизнес, от медицинских сервисов до коммерческих платформ и онлайн продаж",
  allProjectsButton: {
    text: "Все проекты",
    path: "/portfolio",
  },
